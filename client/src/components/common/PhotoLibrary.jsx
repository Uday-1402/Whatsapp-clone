...
function PhotoLibrary({setImage,togglePhotoLibrary}) {
  const images = [
    "/avatars/1.png",
    "/avatars/2.png",
    "/avatars/3.png",
  ...
  <div className="fixed top-0 left-0 max-h[100vh] max-w[100vw] h-full w-full flex justify-center items-center">
    <div className="h-max w-max bg-gray-900 gap-6 rounded-lg p-4">
      <div className = "pt-2 pe-2 cursor-pointer flex justify-end items-end" onClick={()=>togglePhotoLibrary(false)}>
